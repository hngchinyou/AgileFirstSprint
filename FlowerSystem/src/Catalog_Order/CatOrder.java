...
public class CatOrder {
     ...
     */
    public static void COmain(ListInterface<Customer> custList, ListInterface<Flower2> flower, double allOrderPrice, ListInterface<Order> arrOrder, ListInterface<OrderList> orderList) {
    ...
    public static void catalogueOrder(ListInterface<Customer> custList, ListInterface<Flower2> flower, String id, double allOrderPrice, ListInterface<Order> arrOrder, ListInterface<OrderList> orderList, int count5) {
...
//                }
                                ...
                                if (allOrderPrice > ((CorporateCust)  custList.get(i)).getCredit()) {
                                    ...
                                    double getdeprice = 0;
                                    ListInterface<Flower2> fl = new ArrayList<>();
...
//            }        
    ...
    public static void consOrder(ListInterface<Customer> custList, ListInterface<Flower2> flower, String id, double allOrderPrice, ListInterface<Order> arrOrder, ListInterface<OrderList> orderList, int count5) {
...
//            }
    ...
    public static int generateSales(ListInterface<Customer> custList, ListInterface<Flower2> flower, double allOrderPrice, ListInterface<Order> arrOrder, ListInterface<OrderList> orderList) {
    ...
    public static int addQuantity(ListInterface<OrderList> orderList, String orderId, ListInterface<Order> orderItem) {
        int count = 0;
        int count2 = 0;
        int count1 = 0;
        double price = 0;
    ...
    private static int getCustomer(ListInterface<Customer> custList, String id, int count, ListInterface<Flower2> flower, double allOrderPrice, ListInterface<Order> arrOrder, ListInterface<OrderList> orderList) {
        for (int i = 0 ; i < custList.size();i++) {
            if (id.equals(custList.get(i).getId())) {
    ...
    private static int Catalog(ListInterface<Flower2> flower) {
        Scanner scanner = new Scanner(System.in).useDelimiter("\n");
        int count;
        int j = 0;
        int choice;
    ...
    public static String generateOID(ListInterface<OrderList> orderLists) {
        int count = 0;
